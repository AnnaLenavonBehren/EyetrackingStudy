...
public class ShowTargets : MonoBehaviour
{
    ...
    {
        //camOffset.transform.localPosition = (-1) * cam.transform.localPosition;
        ...
        // eig wollen wir nur y setzen
        //Vector3 rotEuler = cam.transform.localEulerAngles;
        //Vector3 newEuler = new Vector3(0, rotEuler.y, 0);
        //camOffset.transform.localEulerAngles = newEuler;
        //camOffset.transform.localRotation = Quaternion.Inverse(cam.transform.localRotation);
    }
    ...
    void updateScoreWinPos()
    {
        ...
        //ScoreWindow.transform.rotation = cam.transform.rotation;
    }
    ...
    IEnumerator PresentTarget(Vector3 t)
    {
        ...
        float x_scaled = targetSize * distance; // / Mathf.Cos(angle_xz * Mathf.Deg2Rad);
        float y_scaled = targetSize * distance; // / Mathf.Cos(angle_yz * Mathf.Deg2Rad);
